...
export default function Header() {
  ...
  return (
    <header className="flex items-center justify-between px-4 sm:px-12 py-4 bg-white shadow-md sticky top-0 z-50">
      {/* Kanban Logo */}
      <div className="text-2xl sm:text-4xl font-bold text-black-700">
        Kanban
      </div>
